...
const TRANSLATIONS = {
  ...
  es: {
    ...
    faq7q:'¿Puedo mencionar a otras personas, como su familia o compañeros de actuación?', faq7a:'Por favor, mantén el enfoque principal en Lee Byung-hun. Para garantizar que el fanbook sea apropiado, es posible que se excluya contenido que no esté relacionado con él o que no sea adecuado para la ocasión.<br><br>[Actualización] Muchas personas han preguntado amablemente si está bien mencionar personas como Lee Min-jung, Park Chan-wook, Lee Jung-jae, u otros.<br><br>Sí — es muy bienvenido mencionar personas relacionadas con su vida o trabajo, como colegas, colaboradores, familiares o amistades, siempre que el mensaje sea respetuoso y mantenga a Lee Byung-hun como enfoque principal.<br><br>Para mantener el fanbook adecuado para algo que se le presentará directamente, podría excluir con cuidado contenido explícitamente NSFW (18+), excesivamente centrado en shipping, o no relacionado con él.<br><br>Muchas gracias por su comprensión y por ayudar a que este proyecto sea cálido y significativo para él. 🤍<br>(Yo también soy fan de Inhun 🥹 — esto es simplemente para mantener todo apropiado para la ocasión.)',
