...
const TRANSLATIONS = {
  ...
  ko: {
    ...
    aboutTitle:'프로젝트 소개',
    aboutText:'📣 이병헌 팬 여러분! <strong>"Lee Byung-hun Global Fan Project"</strong>에 여러분을 초대합니다.<br><br>전 세계 팬들의 메시지를 모아 이병헌에게 전달하기 위한 웹사이트를 만들었습니다. 일본 팬미팅에서 직접 전달하거나, 직접 전달하지 못할 경우 스태프를 통해 전달할 계획입니다.<br><br>팬들이 온라인으로 메시지와 사진 / 팬아트를 제출하면, 모든 것을 인쇄된 <em>팬북 – 글로벌 에디션</em>으로 편집하여 직접 전달하겠습니다. 🤍 (직접 전달할 수 있기를 진심으로 바랍니다!)<br><br>✨ <strong>이것은 개인 프로젝트입니다.</strong> 인쇄 비용은 모두 제가 부담합니다. 일부 이미지는 책에 맞게 약간 조정될 수 있습니다 (최대 약 40페이지 예상).<br><br>이병헌을 중심으로 내용을 유지해 주세요. 팬북의 적절성을 위해 그와 무관하거나 이 자리에 적합하지 않은 내용은 제외될 수 있습니다.<br><br>[업데이트] 이민정, 박찬욱 감독, 이정재 등을 언급해도 되는지 문의를 많이 주셨습니다.<br><br>네 — 그의 삶이나 작업과 관련된 사람들을 언급하는 것은 매우 환영합니다. 동료, 협업자, 가족, 우정 관계 등이 포함되며, 메시지가 정중하고 이병헌을 중심으로 유지되어야 합니다.<br><br>직접 전달될 팬북에 걸맞도록, 명시적인 NSFW(18+) 내용, 지나치게 shipping에 집중된 내용, 또는 그와 무관한 내용은 정중히 제외될 수 있습니다.<br><br>이해와 협조에 진심으로 감사드립니다. 🤍<br>(저도 Inhun 팬입니다 🥹 — 단지 이 자리에 모든 것이 어울리도록 하기 위함입니다.)<br><br>웹사이트는 <strong>디지털 버전</strong>으로도 유지되어 그가 언제든지 팬들의 메시지를 읽을 수 있습니다.<br><br>⏰ <strong>마감일: 2026년 3월 10일</strong><br><small>(3월 말에 책을 준비할 예정입니다.)</small>',
